...
namespace BusinessLogic
{
    public class Pacientes
    {
        ...
        public DataTable Get()
        {
            ...
            {
                string sql;
                sql = " Select IDPACIENTE, PACIENTES.NOMBRE, PACIENTES.DIRECCION, PACIENTES.TELEFONO, PACIENTES.CODIGOPOSTAL, PACIENTES.NIF, PACIENTES.NUMSS, Medicos.NOMBRE from  PACIENTES " +
